...
from PyQt6.QtCore import QSize, QRect, Qt, QRegularExpression
from PyQt6.QtGui import QPalette, QColor, QFont, QIcon, QRegularExpressionValidator


#custom Imports
#import DataCtrl.ImpExpData as ied
#import FileController.MoveFile as mfc
#import UI.WidgetsBuilder as wbui

#importlib.reload(ied)
#importlib.reload(mfc)
#importlib.reload(wbui)
...
class FileManageUI(QMainWindow): #Python2 QtGui.QDialog
    ...
    def __init__(self):
        ...
        #Variable
        self.extList = ["txt", "mkv", "avi", "srt","png"]
        #self.widgetClass = wbui.WidgetBuilder()
        self.extCurrent = ""
    ...
    def initWidget(self):
        ...
        name_png = "C:\\Users\\mateg\\Documents\\GitHub\\MoveTO-repo\\UI\\RaM_Folder_03.png"
        self.searchFoulderBtn.setIcon(QIcon(f"{name_png}"))
        self.searchFoulderBtn.setToolTip("Select Foulder")
